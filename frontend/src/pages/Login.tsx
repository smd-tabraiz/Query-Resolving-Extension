    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0f172a] p-4">
      <div className="w-full max-w-md bg-[#1e293b] rounded-3xl border border-slate-800 p-10 shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-center mt-2">Sign in to access your smart search insights</p>
        </div>
        ...
        <p className="text-center text-slate-500 mt-8 text-sm">
          Don't have an account? <Link to="/register" className="text-sky-400 cursor-pointer hover:underline">Sign up for free</Link>
        </p>
      </div>
    </div>
  );
